package com.clinicapp.users.api.command.endpoint.doctor;
...
import static com.clinicapp.users.api.command.endpoint.doctor.CreateDoctorCommandEndpoint.END_POINT_ADDRESS;
...
public class CreateDoctorCommandEndpoint extends AbstractEndpoint {
    ...
    public Response creteDoctor(CreateDoctorCommand command) {
        try {
